...
<div class="max-w-2xl">
    ...
    {{-- Header --}}
    <div class="mb-8">
        <h1 class="text-xl font-semibold text-gray-800">Tambah Penjualan</h1>
        <p class="text-sm text-gray-400">Input data faktur penjualan</p>
    </div>
